...
import { XColor } from "./xcolor-types";
import { parse as xcolorParser } from "./xcolor-parser";
...
export const XColorCoreModelToColor = {
    ...
    cmyk: ([c, m, y, k]: number[]) =>
        Color([c * 255, m * 255, y * 255, k * 255], "cmyk"),
    hsb: ([h, s, b]: number[]) => Color([h * 360, s * 255, b * 255], "hsv"),
...
const XColorModelToColor = {
    ...
    Hsb: ([h, s, b]: number[]) => Color([h, s * 255, b * 255], "hsv"),

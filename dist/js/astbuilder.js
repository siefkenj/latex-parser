...
// PEG.js parser
const latexpeg = __webpack_require__(1);
// Bare minimum to be able to export a prettier.js doc tree for pretty-printing
const PRETTIER = __webpack_require__(2);
const tokenprinter = __webpack_require__(4);
const TOKENS = tokenprinter.tokens;
__webpack_require__(5).makecompat();
...
/*
 * make exports global objects if we're in the browser
 */
